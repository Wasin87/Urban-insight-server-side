...
// MongoDB URI
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@wasin3.w2xfr9.mongodb.net/?retryWrites=true&w=majority&appName=Wasin3`;
    ...
    try {
        ...
        app.patch('/issues/:id/assign-staff', async (req, res) => {
            try {
                ...
                // Update staff's assigned issues count
                await usersCollection.updateOne(
                    { _id: new ObjectId(assignedStaffId) },
                    { 
    ...
    res.json({ 
        ...
        endpoints: {
            ...
            issues: {
                ...
                status: 'PATCH /issues/:id/status (NEW)',
